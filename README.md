...
- 加入硬件级充电口检测
- 优化了移动数据信号衰减程度检测
- 详情页底层全面重构，解决了扬声器检测问题
- 优化了持续定位问题，更改为只有网络和GPS页面定位
- 优化了电池循环次数计量，但是只是冗余代码，没有厂商日志信息
- 加入了基于电压和电流以及单双电芯实时功率计算
- 加入了电流检测
- 解决了GPS由于国产OEM限制使得没有启用搜星问题
- 加入了数据源问题检测
- 加入了临时应用问题日志，为随时覆盖删除
- 全面UI重构，只保留卡片及渐变色彩风格，删除圆角状态栏
- 优化了处理器温度检测，采用多路径组合
- 解决概览页面快速访问无法跳转问题
- 网络页面加入附近AP信号
- 全面优化对于国产OEM设备信息读取
...
![](10.jpg)
![](11.png)
![](IMG_20260602_231616.jpg)
![](IMG_20260602_231632.jpg)
![](IMG_20260602_231651.jpg)
![](IMG_20260602_231714.jpg)
