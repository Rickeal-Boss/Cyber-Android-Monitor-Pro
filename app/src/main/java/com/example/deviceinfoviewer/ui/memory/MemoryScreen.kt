...
fun MemoryScreen(
    ...
    Column(
        ...
        MetricCard(
            title = "\u5185\u5b58",
            value = "${FormatUtils.formatBytes(availableKB * 1024)} \u53ef\u7528",
            valueColor = NeonPurpleBright,
            subtitle = "${FormatUtils.formatBytes(usedKB * 1024)} \u5df2\u4f7f\u7528 / ${FormatUtils.formatBytes(totalKB * 1024)} \u603b",
            progress = progress,
            showProgress = true
        )
        ...
        if (swapTotalKB > 0) {
            MetricCard(
                ...
                valueColor = NeonPurpleBright,
                subtitle = "\u603b: ${FormatUtils.formatBytes(swapTotalKB * 1024)}",
