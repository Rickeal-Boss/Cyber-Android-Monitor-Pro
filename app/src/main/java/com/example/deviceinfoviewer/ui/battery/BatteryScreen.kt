...
fun BatteryScreen(
    ...
    val battTempChart by remember(historyData) { derivedStateOf { normalizeChartData(historyData["battery_temp"], 60f) } }
    val battLevelChart by remember(historyData) { derivedStateOf { normalizeChartData(historyData["battery_level"], 100f) } }
    val battPowerChart by remember(historyData) { derivedStateOf { normalizeChartData(historyData["battery_power"], 30000f) } }
