...
fun BatteryScreen(
    ...
    Column(
        ...
        // === 电池健康度 SOH%（学术依据: ICCPS 2017 — Android 只报告 "good/dead"，需自算）===
        val healthPercent = batteryInfo?.sohPercent
        ...
        if (healthPercent != null) {
            MetricCard(
                ...
                subtitle = "${nowCap ?: batteryInfo?.chargeFullMAh ?: "?"} / ${designCap ?: batteryInfo?.chargeFullDesignMAh ?: "?"} mAh"
            ) { }
        }
