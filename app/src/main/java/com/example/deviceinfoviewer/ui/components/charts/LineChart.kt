...
fun DualLineChart(
    ...
    Canvas(modifier = modifier
        ...
        drawOneLine(data1, visibleCount, brush1, lineColor1, xs, ys, pad, cw, ch, path)
        drawOneLine(data2, visibleCount, brush2, lineColor2, xs, ys, pad, cw, ch, path)
    }
}
...
private fun DrawScope.drawOneLine(
    ...
    val xStep = cw / (pointCount - 1).coerceAtLeast(1).toFloat()
