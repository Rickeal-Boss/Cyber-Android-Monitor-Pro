...
fun GpuScreen(
    ...
    val gpuLoadChart by remember(historyData) { derivedStateOf { normalizeChartData(historyData["gpu_load"], 100f) } }
    val gpuTempChart by remember(historyData) { derivedStateOf { normalizeChartData(historyData["gpu_temp"], 100f) } }
    val gpuFreqChart by remember(historyData) { derivedStateOf { normalizeChartData(historyData["gpu_freq"], 100f) } }
