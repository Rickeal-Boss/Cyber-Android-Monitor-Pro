...
// Material 3 Typography — 全系统字体（排查闪退用）
val Typography = Typography(
    ...
    bodyLarge = TextStyle(fontFamily = FontFamily.Default, fontWeight = FontWeight.Bold, fontSize = 16.sp, lineHeight = 24.sp, letterSpacing = 0.5.sp),
