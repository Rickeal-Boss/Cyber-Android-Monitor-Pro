...
private fun RefreshIntervalCard() {
    val savedMs = remember { FloatingWindowConfig.refreshIntervalMs }
    ...
    Card(
        ...
        Column(Modifier.padding(horizontal = 16.dp, vertical = 12.dp)) {
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween,
                ...
                Text(formatMs(currentMs.toLong()), fontSize = 18.sp,
                    fontWeight = FontWeight.Bold, color = NeonPurpleBright)
            }

            Spacer(Modifier.height(4.dp))
            Text(stringResource(R.string.float_refresh_status) + ": ${if (currentMs.toLong() >= 1000) "节能" else "实时"}",
            ...
            Slider(
                ...
                onValueChangeFinished = {
                    FloatingWindowConfig.refreshIntervalMs = currentMs.toLong()
                },
